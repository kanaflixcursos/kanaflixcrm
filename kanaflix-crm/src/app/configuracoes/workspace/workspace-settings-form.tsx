...
export function WorkspaceSettingsForm({ workspace }: Readonly<{ workspace: { name: string; logo_url: string | null } }>) {
  ...
  return (
    <form action={formAction} className="max-w-3xl rounded-3xl border border-border bg-surface p-6 shadow-sm sm:p-8">
      ...
      <div className="mt-8 grid gap-5 border-t border-border pt-6">
        ...
        <ImageUploadField name="logoUrl" label="Logo do workspace" defaultValue={workspace.logo_url} />
      </div>
